...
function dockerJobRunner(config, d) {
    ...
    d.tasks = [
        ...
        "cd /src/linux-container-workshop/app/web",
...
function kubeJobRunner (config, k) {
    ...
    k.tasks = [
        `kubectl set image deployment/heroes-web-deploy heroes-web-cntnr=pmwcontainerregistry.azurecr.io/azureworkshop/rating-web:${config.get("imageTag")}`
    ]
}
